class RscTitles
{
	...
	class playerStatusWaiting
	{
		...
		class Controls {
			class RscPicture_1401: RscPicture
			{
				idc = 1401;
	...
	class playerStatusGUI
	{
		...
		class ControlsBackground {
			...
			class RscPicture_1501: RscPicture
			{
				idc = 1501;
				text = "\z\addons\dayz_code\gui\status_food_border_ca.paa";
			...
			class RscPicture_1502: RscPicture
			{
				idc = 1502;
				text = "\z\addons\dayz_code\gui\status_thirst_border_ca.paa";
				x = 0.945313 * safezoneW + safezoneX;
		...
		class Controls{
			...
			class RscPicture_1306: RscPicture
			{
				idc = 1306;
			...
			class RscPicture_1307 : RscPicture {
				idc = 1307;
			...
			class RscPicture_1701: RscPicture
			...
			class RscPicture_1702: RscPicture
			{
				idc = 1702;
				//text = "\z\addons\dayz_code\gui\status_thirst_inside_ca.paa";
				x = 0.945313 * safezoneW + safezoneX;
