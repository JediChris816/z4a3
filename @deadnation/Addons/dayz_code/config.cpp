...
class CfgPatches {
	class dayz_code {
		...
		weapons[] = {};
		requiredVersion = 0.1;
		requiredAddons[] = {"dayz_equip","dayz_weapons","deadnation"};
	};
...
class CfgMissions
{
	 class Cutscenes
	 {
	  class Altis_Intro1
		  {
			directory = "z\addons\dayz_code\cfgworlds\intro1.Altis";
		  };
	 };
};
...
class CfgBuildingLoot {
	class Default {
		...
		minRoaming = 0;
		maxRoaming = 2;
		zombieClass[] = {"zZombie_Base","z_villager3","z_villager2","z_villager1","z_policeman","z_DN_zed","z_DN_officer","z_DN_zedwoman","z_DN_zed","z_DN_officer","z_DN_zedwoman","z_DN_zedmalebig"};
		lootChance = 0;
		lootPos[] = {};
		itemType[] = {};
		itemChance[] = {};
	...
	class Residential: Default {
		zombieChance = 0.3;
		maxRoaming = 2;
		zombieClass[] = {"zZombie_Base","z_villager3","z_villager2","z_villager1","z_policeman","z_DN_zed","z_DN_officer","z_DN_zedwoman","z_DN_zed","z_DN_officer","z_DN_zedwoman"};
		lootChance = 0.4;
		lootPos[] = {};
		itemType[] =	{
			...
			{"WeaponHolder_ItemTent","magazine"},
			{"","military"},
			{"","civilian"},
			{"","civilian"},
			{"Binocular","weapon"},
	...
	class Supermarket: Default {
		...
		itemType[] = {
			...
			{"SMG_01_F","weapon"},
			{"hgun_Rook40_F","weapon"},
			{"ItemAntibacterialWipe","magazine"},
			{"WeaponHolder_ItemTent","magazine"},
			{"B_Kitbag_BaseDN","backpack"},
			{"B_Bergen_BaseDN","backpack"}, // 18
			{"B_AssaultPack_blkDN","backpack"}, // 24
	...
	class Military: Default {
		zombieChance = 0.3;
		maxRoaming = 6;
		zombieClass[] = {"z_soldier","z_soldier_heavy","z_policeman","z_DN_zed","z_DN_officer","z_DN_zedwoman","z_DN_zedmalebig"};
		lootChance = 0.4;
		lootPos[] = {};
		itemType[] =	{
			{"hgun_ACPC2_F","weapon"},
	...
	class Land_Dome_Small_F : Hospital {
		...
		maxRoaming = 6;
		zombieChance = 0.5;
		zombieClass[] = {"zZombie_Base","z_villager3","z_villager2","z_villager1","z_policeman","z_DN_zed","z_DN_officer","z_DN_zedwoman"};
	...
	class Land_Dome_Big_F : Hospital {
		...
		maxRoaming = 6;
		zombieChance = 0.5;
		zombieClass[] = {"zZombie_Base","z_villager3","z_villager2","z_villager1","z_policeman","z_DN_zed","z_DN_officer","z_DN_zedwoman","z_DN_zedmalebig"};
		...
		maxRoaming = 6;
		zombieChance = 0.5;
		zombieClass[] = {"z_soldier", "z_soldier_heavy", "z_policeman","z_DN_zed","z_DN_officer","z_DN_zedwoman"};
	...
	class Land_cargo_addon01_V2_F : Office {
		...
		maxRoaming = 6;
		zombieChance = 0.5;
		zombieClass[] = {"zZombie_Base","z_villager3","z_villager2","z_villager1","z_policeman","z_DN_zed","z_DN_officer","z_DN_zedwoman","z_DN_zedmalebig","z_deadsurvivor"};
		lootPos[] = {{-1.31958, 0.655151, -0.57000}, {-1.82349, 0.769653, -0.57000}, {-1.67871, 0.918701, -0.57000}, {-1.41958, 0.755151, -0.57000}, {-1.72349, 0.759653, -0.57000}, {-1.59871, 0.898701, -0.57000}};
	};
	...
	class UH1Wreck_DZ : Helicrash {
		zombieClass[] = {"z_soldier_pilot", "z_soldier_heavy"};
		zombieChance = 1;
		lootChance = 0.5;
		minRoaming = 6;
		maxRoaming = 8;
		lootPos[] = {{-0.5,-2.1,-0.20}, {-0.5,-2.6,-0.20}, {-0.5,-3.1,-0.20}, {-0.5,-3.7,-0.20}, {1.5,-5.2,-0.70}};
	};
	class UH60Wreck_DZ : Helicrash {
		zombieClass[] = {"z_soldier_pilot", "z_soldier_heavy"};
		zombieChance = 1;
		lootChance = 0.5;
		minRoaming = 6;
	...
	class Land_s1203_DayZ : LootWreck {
		lootChance = 0.3;
		lootPos[] = {{0.2,1.7,-0.6}, {-0.5,1.7,-0.6}, {0.3,-1.1,-0.2}};
	};
	class Land_s1203_baige_DayZ : LootWreck {
		lootChance = 0.3;
		lootPos[] = {{0.2,1.7,-0.6}, {-0.5,1.7,-0.6}, {0.3,-1.1,-0.2}};
	};
	class Land_Volha_DayZ : LootWreck {
		lootChance = 0.3;
		lootPos[] = {{0.5,-0.2,-0.2}, {-0.4,-0.2,-0.25}, {-0.4,0.7,-0.25}, {0.4,0.7,-0.25}, {0.4,2.1,-0.25}, {-0.25,1.95,-0.25}};
	};
	class Land_Volha_grey_DayZ : LootWreck {
		lootChance = 0.3;
		lootPos[] = {{0.5,-0.2,-0.2}, {-0.4,-0.2,-0.25}, {-0.4,0.7,-0.25}, {0.4,0.7,-0.25}, {0.4,2.1,-0.25}, {-0.25,1.95,-0.25}};
	};
	class Land_Volha_police_DayZ : LootWreck {
		lootChance = 0.3;
		lootPos[] = {{0.5,-0.2,-0.2}, {-0.4,-0.2,-0.25}, {-0.4,0.7,-0.25}, {0.4,0.7,-0.25}, {0.4,2.1,-0.25}, {-0.25,1.95,-0.25}};
	};
	class Land_Lada_DayZ : LootWreck {
		lootChance = 0.3;
		lootPos[] = {{-0.25,1.6,-0.25}, {0.5,1.7,-0.25}, {0.5,0.5,-0.2}, {-0.2,0.5,-0.2}, {-0.2,-0.2,-0.2}, {0.5,-0.2,-0.2}};
	};
	class Land_Lada_red_DayZ : LootWreck {
		lootChance = 0.3;
		lootPos[] = {{-0.25,1.6,-0.25}, {0.5,1.7,-0.25}, {0.5,0.5,-0.2}, {-0.2,0.5,-0.2}, {-0.2,-0.2,-0.2}, {0.5,-0.2,-0.2}};
	};
	class Land_Ikarus_Dayz : LootWreck {
		lootChance = 0.3;
		lootPos[] = {{0.0,-0.0,-0.5}, {-0.5,-2.2,-0.5}, {0.8,-4.5,-0.15}, {0.8,4.5,-0.5}, {-0.7,0.8,-0.4}};
	};
};