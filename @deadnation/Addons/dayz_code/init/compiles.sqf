...
if (!isDedicated) then {
    ...
    BIS_Effects_Burn=compile preprocessFile "\dz\data\data\ParticleEffects\SCRIPTS\destruction\burn.sqf";
	...
	VAS_fnc_fetchCfgDetails = 	compile preprocessFileLineNumbers "\z\addons\dayz_code\system\SES_FetchCfgDetails.sqf";
	SES_LoadGear =				compile preprocessFileLineNumbers "\z\addons\dayz_code\system\SES_LoadGear.sqf";
    ...
    unit_dropWeapon = {
        ...
        if (_currentGun != "") then {
            _item = createVehicle ["groundweaponHolder", getPos player, [], 1, "CAN_COLLIDE"];
