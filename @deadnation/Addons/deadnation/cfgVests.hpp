	...
	class DN_Vest: V_Rangemaster_belt
	{	
		scope = 2; /// scope needs to be 2 to have a visible class
		displayName  = "Survival vest"; /// how would the stuff be displayed in inventory and on ground
		picture = "\deadnation\textures\icovest.paa"; /// this icon fits the vest surprisingly well
		model   = "\deadnation\models\vest.p3d"; /// what model does the vest use
		
		class ItemInfo: ItemInfo
		{
			uniformModel   = "\deadnation\models\vest.p3d"; /// what model does the vest use
			mass = 20;
			armor = 5*0.2;
			passThrough = 0.8;
		};
